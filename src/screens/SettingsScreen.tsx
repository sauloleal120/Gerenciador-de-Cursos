...
export function SettingsScreen({route}) {
  ...
  const {emailAtual, usuarioAtual, passwordAtual} = route.params;
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <View style={styles.button}>
            ...
            <Text style={styles.secondaryText}> {passwordAtual} </Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
